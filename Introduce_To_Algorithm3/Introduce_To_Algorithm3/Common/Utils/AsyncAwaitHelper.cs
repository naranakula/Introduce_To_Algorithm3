...
namespace Introduce_To_Algorithm3.Common.Utils
{
    ...
    /// 7)Task有IsFaulted属性标记任务是否正常完成，当发生异常时，IsFaulted=true,await捕获异常，并重新在当前线程抛出，当返回void时，如果有SyncronizationContext(如winform和wpf，异常仍然传递给了UI线程)，异常传递给该context,否则传递给thread pool
