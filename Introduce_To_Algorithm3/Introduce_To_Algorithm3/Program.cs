...
/*
            ...
            string connstring = @"User ID=sa;Initial Catalog=MyAPPS;Data Source=chlu-pc\CHLU;Password=558276344";
            SqlHelper helper = SqlHelper.GetInstance(connstring);
            string sql = @"INSERT INTO [MyApps].[dbo].[App]
           ([Id]
           ,[AppName]
           ,[Description]
           ,[CreateTime])
     VALUES
           ...
           @CreateTime)";
            ...
            parameters[1] = new SqlParameter("@AppName",SqlDbType.NVarChar){Value = appName};
            parameters[2] = new SqlParameter("@Description",SqlDbType.NVarChar){Value = description};
